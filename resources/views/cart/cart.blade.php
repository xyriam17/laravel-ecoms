        ...
        <div class="col-md-8 cart">
            ...
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    <div class="col">
                        <div class="row">Your Cake</div>
                    </div>
                    <form method="POST" action="{{ route('cart.addToCart') }}">
                        @csrf
                        <div class="col">
                            <a href="#" class="border btn btn-link" id="quantity">{{ $product['quantity'] }}</a>
                            <input type="hidden" name="product_id" value="{{ $product['product_id'] }}">
                            <button class="btn btn-link" type="button" onclick="decreaseQuantity()">-</button>
                    ...
                    <div class="col">PHP{{ $product['product_total'] }}
                        <a href="{{ route('cart.remove', $product) }}"><span class="close">&#10005;</span></a></div>
                </div>
            </div>
            @endforeach
